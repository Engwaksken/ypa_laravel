...
<div class="dash-wrap">
    ...
    <div class="dash-head">
        <div>
            <h1 class="dash-name">Add Mobilizer</h1>
            <div class="dash-date">Create a new mobilizer record</div>
        </div>
    ...
    <form method="POST" action="{{ route('mobilizers.store') }}">
        @csrf
            ...
            <div class="dash-panel-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="contact_number" value="{{ $old['contact_number'] ?? '' }}" class="form-control @error('contact_number') is-invalid @enderror" placeholder="+256..." required>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="branch_region" class="form-select @error('branch_region') is-invalid @enderror">
                            ...
                            @foreach($branches as $branch)
                                <option value="{{ $branch->name }}" @selected(($old['branch_region'] ?? '') === $branch->name)>{{ $branch->name }}</option>
                            @endforeach
                        </select>
        ...
        <div class="d-flex gap-2 mt-4 mb-4">
            <button type="submit" class="btn btn-primary btn-lg"><i class="fas fa-save"></i> Add Mobilizer</button>
            <a href="{{ route('mobilizers.index') }}" class="btn btn-outline-secondary btn-lg">Cancel</a>
        </div>
    </form>
